'use strict';
    ...
    // Harrison and Bex 2014
    var flankers=['A','B','D','E','F','H','I','J','L','K','M','N','P','R','S','T','V'];
    ...
    class MOCS {
            ...
            next() {
                ...
                var flanker_code;
                if (get_checked( "chkLetters" )) {
                    shuffleArray(flankers);     // generate new flankers array also
                    flanker_code=flankers[0]+flankers[1]+flankers[2]+flankers[3];
                } else {
                    var oris=['0','1','2','3'];
                    shuffleArray(oris);
